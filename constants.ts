...
import { ColorInfo, ColorKey } from './types';
...
export const DEFAULT_PALETTE: ColorInfo[] = [
  ...
  { key: 'D_PURPLE', name: '深紫', hex: '#4A235A', label: '深紫' }, // Darker
  { key: 'D_GREEN', name: '深綠', hex: '#276221', label: '深綠' },
  { key: 'GRAY', name: '灰色', hex: '#95A5A6', label: '灰' },
  { key: 'D_BLUE', name: '深藍', hex: '#154360', label: '深藍' }, // Darker
  { key: 'L_BLUE', name: '水藍', hex: '#70A1FF', label: '水藍' },
  { key: 'ORANGE', name: '橘色', hex: '#E67E22', label: '橘' },
  { key: 'CYAN', name: '蒂芬妮綠', hex: '#00FDDC', label: '芬' }, // Brighter Tiffany
  { key: 'PURPLE', name: '紫色', hex: '#9B59B6', label: '紫' },
  { key: 'D_RED', name: '鮮紅', hex: '#FF0000', label: '鮮紅' }, // Brighter Red
